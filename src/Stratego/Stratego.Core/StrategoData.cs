...
namespace Stratego.Core
{
    ...
    //    private readonly ReadOnlyCollection<Guid> listOfPlayers;
    ...
    //        listOfPlayers = new ReadOnlyCollection<Guid>(players);
    //    }
    ...
    //    /// </summary>
    //    /// <returns></returns>
    //    public Tuple<GameInfo, ReadOnlyCollection<Guid>> GetData()
    //    {
    //        return new Tuple<GameInfo, ReadOnlyCollection<Guid>>(info, listOfPlayers);
    //    }
